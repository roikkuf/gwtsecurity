...
<html>
    <head>
        ...
        <script type="text/javascript"><!--
            var _gaq = _gaq || [];
            _gaq.push(['_setAccount', 'UA-22086822-4']);
        ...
        <script type="text/javascript" language="javascript" src="demo2/demo2.nocache.js"></script>
    </head>
    ...
    <body>
        ...
        <h1>Gwt for Spring Security <a href="http://code.google.com/p/gwt-sl/">gwt-sl</a> Demo</h1>
