...
public class GwtRememberMeAuthenticationException extends GwtAuthenticationException {
    ...
    /**
     * Instantiates a new {@link GwtRememberMeAuthenticationException}.
     */
     ...
     */
    public GwtRememberMeAuthenticationException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @param message the message
     */
    public GwtRememberMeAuthenticationException(final String message) {
        super(message);
    }
     ...
     * @param cause the cause
     */
    public GwtRememberMeAuthenticationException(final Throwable cause) {
        super(cause);
    }
